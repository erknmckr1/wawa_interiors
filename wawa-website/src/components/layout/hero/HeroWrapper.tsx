...
const HeroWrapper = () => {
  return (
    <FadeInSection>
      <section className="relative w-full   lg:h-[800px]">
        ...
        <div className="relative container flex flex-col lg:flex-row justify-between items-center w-full mx-auto py-12 sm:h-[800px]">
          <FadeInSection>
            <HeroLeft />
          </FadeInSection>
          <HeroSliderIndicator />
